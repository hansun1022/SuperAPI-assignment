...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.window = Tk()
        self.window.title("SuperApi Assignment")
    ...
    def display_title(self):
        ...
        title = Label(self.window, text="Let's play a Quiz Game",
                      width=50, bg="skyblue", fg="white", font=("ariel", 20, "bold"))
    ...
    def buttons(self):
        ...
        next_button = Button(self.window, text="Next", command=self.next_btn,
                             width=10, bg="skyblue", fg="white", font=("ariel", 16, "bold"))
